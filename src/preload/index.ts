...
const api: BlueLedgerApi = {
  ...
  sync: {
    ...
    repair: () => invoke("sync:repair"),
    getDiagnostics: () => invoke("sync:get-diagnostics"),
    listBlocked: () => invoke("sync:list-blocked"),
  ...
  report: {
    ...
    stockAsOfDate: (input) => invoke("report:stock-as-of-date", input),
