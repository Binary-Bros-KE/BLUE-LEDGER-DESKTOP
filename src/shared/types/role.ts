...
export const PERMISSION_MODULES = [
  ...
  { key: "data_import", label: "Data Import", actions: ["view", "edit"] },
  { key: "owner_app", label: "Owner Mobile App", actions: ["view"] },
  { key: "online_store", label: "Online Store", actions: ["view", "edit"] },
